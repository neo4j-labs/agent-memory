...
image::diagrams/learn-from-behavior-patterns.png[Learn from Behavior Patterns]
...
image::diagrams/filter-products-by-preferences.png[Filter Products by Preferences]
