...
image::diagrams/1-natural-relationship-modeling.png[1. Natural Relationship Modeling]
...
image::diagrams/data-model.png[Data Model]
...
image::diagrams/example-queries.png[Example Queries]
...
image::diagrams/inventory-aware-recommendations.png[Inventory-Aware Recommendations]
