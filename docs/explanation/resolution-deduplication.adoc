...
image::diagrams/1-relationship-integrity.png[1. Relationship Integrity]
...
image::diagrams/keep-primary-default.png[Keep Primary (Default)]
...
image::diagrams/subsidiary-relationships.png[Subsidiary Relationships]
