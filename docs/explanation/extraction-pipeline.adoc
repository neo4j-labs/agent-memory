...
image::diagrams/three-extraction-approaches-pipeline.png[Three Extraction Approaches Pipeline]
...
image::diagrams/extraction-pipeline.png[Extraction Pipeline]
