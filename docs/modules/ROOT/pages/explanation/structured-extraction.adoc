...
NOTE: This provider configuration is a Bolt capability. NAMS performs extraction and completion calls server-side and does not expose these provider adapters. See xref:explanation/backends.adoc[Bolt and NAMS].
