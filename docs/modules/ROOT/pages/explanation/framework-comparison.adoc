...
Backend support is a separate question. Python supports Bolt and NAMS; TypeScript targets NAMS REST. Shared concepts do not imply identical operations or result shapes. Consult xref:reference/backend-capabilities.adoc[Backend capabilities] and xref:explanation/backends.adoc[Bolt and NAMS] before choosing an adapter around preferences, graph writes, extraction, or user scoping.
