...
image::diagrams/the-three-layer-memory-architecture.png["Three-layer memory architecture: short-term, long-term, and reasoning memory backed by Neo4j",width=600,align=left,link=self]

image::diagrams/three-memory-types-diagram.png["The three memory layers: Conversation and Message records; entities, preferences, and facts; and recorded traces, steps, and tool calls",width=600,align=left,link=self]
