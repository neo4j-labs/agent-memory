...
NOTE: These are Bolt-side provider choices. NAMS manages extraction and embeddings server-side. Current source and a published SDK artifact may expose different provider surfaces; use the reference for the version you have installed.
