= from_provider factory reference
...
anchor:_related[]
The earlier sections have been consolidated into the current contracts. See xref:reference/api/factory.adoc#_see_also[related provider and protocol references].
