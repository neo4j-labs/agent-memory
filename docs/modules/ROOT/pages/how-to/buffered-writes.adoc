...
image::diagrams/buffered-write-flow.png[Buffered write architecture: agent submits to bounded queue; background drainer pushes to Neo4j,width=600,align=left,link=self]
