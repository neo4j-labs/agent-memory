...
vice versa). The hosted service exposes a richer surface
(xref:explanation/context-tiers.adoc[three-tier context], entity feedback,
graph view); the bridge supports the legacy long-term/reasoning operations
from the TCK.
