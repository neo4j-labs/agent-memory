...
The ontology is the schema server-side extraction is validated against. The
accessor is available on both backends (on bolt it is stored in your own Neo4j
and drives local extraction — see
