...
- GLiNER2.5 for entity and relation extraction
...
The first run downloads the GLiNER2.5 model (~407 MB for the default
`fastino/gliner2.5-base-v1`). This is normal and only happens once.
