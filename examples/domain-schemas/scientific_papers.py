#!/usr/bin/env python3
"""Compatibility wrapper: research paper analysis.
...
v0.6. This file is kept for one release so existing links keep working:
    ...
    python run.py --schema scientific

Any extra arguments are forwarded, so `python scientific_papers.py --store` still works.
"""
...
if __name__ == "__main__":
    ...
    print("      The corpus moved to samples/scientific.py; this wrapper goes away next release.\n")
