#!/usr/bin/env python3
"""Compatibility wrapper: podcast transcript analysis.
...
v0.6. This file is kept for one release so existing links keep working:
    ...
    python run.py --schema podcast

Any extra arguments are forwarded, so `python podcast_transcripts.py --store` still works.
"""
...
if __name__ == "__main__":
    ...
    print("      The corpus moved to samples/podcast.py; this wrapper goes away next release.\n")
